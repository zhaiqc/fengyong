...
//                          color: AppConfig.widgetColor,
        ...
        SliverList(
          delegate: SliverChildListDelegate([
            Container(
              height: AppConfig.logic_width(460) * 7.5,
                            ...
                            Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Container(margin: EdgeInsets.only(top:  index.isEven?AppConfig.logic_width(35):AppConfig.logic_width(50),bottom:index.isEven?AppConfig.logic_width(5):AppConfig.logic_width(10) ),
                                    child: Row(
                                      children: [
                                        Container(
