...
import 'package:flutter_app_shop/login/view_model/LoginViewModel.dart';
import 'package:flutter_app_shop/root/RootPage.dart';
import 'package:flutter_app_shop/utils/AppConfig.dart';
import 'package:flutter_app_shop/utils/widgets/text_field.dart';
...
//        build_reg()
  ...
  Widget button(){
    ...
    child:FlatButton(
      ...
      disabledColor:AppConfig.mainColor.withOpacity(0.6),
      disabledTextColor: AppConfig.mainColor.withOpacity(0.8),
      child:  Column(
...
timerController.startTimer();
  ...
  void loginSuccess(msg) {
    Toast.show(msg, context);
    Navigator.pushReplacement(context, new MaterialPageRoute(builder: (_) => new RootPage()));
