...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case HomeEntity:
			...
			return homeDataArticleFromJson(data as HomeDataArticle, json) as T;			case ArticleListEntity:
			...
			return uploadDataFromJson(data as UploadData, json) as T;			case ShopEntity:
			...
			return shopDataManystoreFromJson(data as ShopDataManystore, json) as T;			case ShopListEntity:
			...
			return shopListDataManystoretapsTextFromJson(data as ShopListDataManystoretapsText, json) as T;			case LoginEntity:
			...
			return loginDataUserinfoFromJson(data as LoginDataUserinfo, json) as T;			case CodeEntity:
			return codeEntityFromJson(data as CodeEntity, json) as T;    }
    return data as T;
  }
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case HomeEntity:
			...
			return homeDataArticleToJson(data as HomeDataArticle);			case ArticleListEntity:
			...
			return uploadDataToJson(data as UploadData);			case ShopEntity:
			...
			return shopDataManystoreToJson(data as ShopDataManystore);			case ShopListEntity:
			...
			return shopListDataManystoretapsTextToJson(data as ShopListDataManystoretapsText);			case LoginEntity:
			...
			return loginDataUserinfoToJson(data as LoginDataUserinfo);			case CodeEntity:
			return codeEntityToJson(data as CodeEntity);    }
    return data as T;
  }
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'HomeEntity':
			...
			return HomeDataArticle().fromJson(json);			case 'ArticleListEntity':
			...
			return UploadData().fromJson(json);			case 'ShopEntity':
			...
			return ShopDataManystore().fromJson(json);			case 'ShopListEntity':
			...
			return ShopListDataManystoretapsText().fromJson(json);			case 'LoginEntity':
			return LoginEntity().fromJson(json);			case 'LoginData':
			return LoginData().fromJson(json);			case 'LoginDataUserinfo':
			return LoginDataUserinfo().fromJson(json);			case 'CodeEntity':
			return CodeEntity().fromJson(json);    }
    return null;
  }
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'HomeEntity':
			...
			return List<HomeDataArticle>();			case 'ArticleListEntity':
			...
			return List<UploadData>();			case 'ShopEntity':
