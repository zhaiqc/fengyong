...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case CodeEntity:
			return codeEntityFromJson(data as CodeEntity, json) as T;			case UploadEntity:
			return uploadEntityFromJson(data as UploadEntity, json) as T;			case UploadData:
			return uploadDataFromJson(data as UploadData, json) as T;			case ShopListEntity:
			...
			return shopListDataManystoretapsTextFromJson(data as ShopListDataManystoretapsText, json) as T;			case ShopEntity:
			...
			return shopDataManystoreFromJson(data as ShopDataManystore, json) as T;			case HomeEntity:
			...
			return homeDataShopListShopListManystoretapsTextFromJson(data as HomeDataShopListShopListManystoretapsText, json) as T;			case LoginEntity:
			...
			return loginDataUserinfoFromJson(data as LoginDataUserinfo, json) as T;    }
    return data as T;
  }

  static _getToJson<T>(Type type, data) {
		switch (type) {			case CodeEntity:
			return codeEntityToJson(data as CodeEntity);			case UploadEntity:
			return uploadEntityToJson(data as UploadEntity);			case UploadData:
			return uploadDataToJson(data as UploadData);			case ShopListEntity:
			...
			return shopListDataManystoretapsTextToJson(data as ShopListDataManystoretapsText);			case ShopEntity:
			...
			return shopDataManystoreToJson(data as ShopDataManystore);			case HomeEntity:
			...
			return homeDataShopListShopListManystoretapsTextToJson(data as HomeDataShopListShopListManystoretapsText);			case LoginEntity:
			...
			return loginDataUserinfoToJson(data as LoginDataUserinfo);    }
    return data as T;
  }
  //Go back to a single instance by type
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'CodeEntity':
			return CodeEntity().fromJson(json);			case 'UploadEntity':
			return UploadEntity().fromJson(json);			case 'UploadData':
			return UploadData().fromJson(json);			case 'ShopListEntity':
			...
			return ShopListDataManystoretapsText().fromJson(json);			case 'ShopEntity':
			...
			return ShopDataManystore().fromJson(json);			case 'HomeEntity':
			...
			return HomeDataShopListShopListManystoretapsText().fromJson(json);			case 'LoginEntity':
			return LoginEntity().fromJson(json);			case 'LoginData':
			return LoginData().fromJson(json);			case 'LoginDataUserinfo':
			return LoginDataUserinfo().fromJson(json);    }
    return null;
  }
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'CodeEntity':
			...
			return List<ShopDataManystore>();			case 'HomeEntity':
			...
			return List<HomeDataShopListShopListManystoretapsText>();			case 'LoginEntity':
			return List<LoginEntity>();			case 'LoginData':
			return List<LoginData>();			case 'LoginDataUserinfo':
			return List<LoginDataUserinfo>();    }
    return null;
  }
